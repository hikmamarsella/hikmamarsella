                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Edit Admin</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group">
                                                <div class="input-group">
                                                    <input type="hidden" id="id" name="id_user" value="<?php echo $data['id_user']; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" id="username" name="password" value="<?php echo $data['password']; ?>" class="form-control">
                                                </div>
                                            </div>
            ...
            <section>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © Registrasi seminar proposal STTP-2020.</p>
                            </div>
                        </div>
                    </div>
                </div>
