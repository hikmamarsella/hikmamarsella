...
<head>
    ...
    <!-- Title Page-->
    <title>Edit Peserta Seminar</title>
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a href="../data-seminar.php">
                                <i class="fas fa-users"></i>Data Peserta Seminar Proposal</a>
                        </li>
                        <li>
        ...
        <div class="page-container2">
            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">Edit Peserta Seminar</div>
                                    <div class="card-body card-block">
                                        <form action="proses.php?aksi=update" method="post" class="">
                                        <?php
                                        ...
                                        <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="hidden" id="id" name="id" value="<?php echo $data['id']; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="username" name="nama" value="<?php echo $data['nama']; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="username" name="alamat" value="<?php echo $data['alamat']; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="username" name="tgl_lahir" value="<?php echo $data['tgl_lahir']; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
            ...
            <section>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2018 Registrasi seminar proposal STTP-2020.</p>
                            </div>
                        </div>
                    </div>
                </div>
