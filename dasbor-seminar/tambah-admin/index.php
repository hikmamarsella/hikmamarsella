...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container2">
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Data Admin</li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">Tambah Administrator</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header"><font color="black">Tambah Administrator</font></div>
                                        ...
                                        <form action="isi.php" method="post" class="">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="username" name="username" placeholder="Nama Pengguna" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <select name="ha" id="ha" class="form-control" required="">
                                            ...
                                            <div class="form-actions form-group">
                                                <input type="submit" class="btn btn-success btn-sm" value="Tambah Admin">
                                            </div>
                                        </form>
                                    </div>
                                </div>
