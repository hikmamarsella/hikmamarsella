...
<?php
include "config.php";
$query = mysqli_query($connection,"select * from user where nama like '%$nama%'");
?>
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a href="#">
                                <i class="fas fa-chart-bar"></i>Data Peserta Seminar Proposal</a>
                        </li>
                    </ul>
                </nav>
            </div>
                            ...
                            <div class="header-button2">
                                <div class="header-button-item js-item-menu">
                                    ...
                                    <div class="search-dropdown js-dropdown">
                                        <form action="">
                                            <input class="au-input au-input--full au-input--h65" type="text" placeholder="Apa yang Anda cari?" />
